                ...
                <form className="formContainer" onSubmit={loginHandler}>
                    <div className="mobile">
                        <label htmlFor="mobile">
                            <input type="text" name="mobileNo" id="mobile" className="input" placeholder=" Mobile Number " minLength={10} maxLength={10} />
                        </label>
                    </div>
                    <div className="mPin">
                        <input type={password === true ? "text" : "password"} name="mPin" id="mPin" className="input" placeholder="MPin" minLength={4} maxLength={4} />
                        <img src={require("../../../assets/images/eye_on.png")} alt="eye" className='toggleEye' onClick={togglePassword} />
                    </div>
